...
urlpatterns = [
    ...
    path('midterm-result/', views.midterm_result, name='midterm-resultt'),
    # path('error/', views.error_view, name='error'),
    path('student-dashboard', views.student_dashboard_view,name='student-dashboard'),
    path('student-attendance', views.student_attendance_view,name='student-attendance'),

    # path('teacher_add_student_mark', views.teacher_add_student_mark,name='teacher_add_student_mark'),
    # path('student_mark_view', views.student_mark_view,name='student_mark_view'),
    # path('teacher/profile/', views.teacher_profile, name='teacher_profile'),
    # path('student/profile/', views.student_profile, name='student_profile'),
    # path('subjects/', views.subject_list, name='subject-list'),
    # path('add/marksheet/', views.add_marksheet, name='add-marksheet'),
